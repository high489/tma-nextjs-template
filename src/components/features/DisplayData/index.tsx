...
export const DisplayData: FC<DisplayDataProps> = ({ header, rows }) => (
  <Section header={header} className={styles['header']}>
    {rows.map((item, idx) => {
      ...
      return (
        <Cell
          ...
          key={idx}
        >
          <span className={styles['line-value']}>{valueNode}</span>
        </Cell>
      )
    })}
  </Section>
